...
export default function CampusLife() {
  ...
  return (
    <section className="py-24 md:py-32 bg-slate-950 relative" id="gallery">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          {filteredGallery.map((photo) => (
            <motion.div
              ...
              className="break-inside-avoid relative rounded-2xl overflow-hidden group cursor-pointer border border-white/5 shadow-lg shadow-black/40"
            ...
            >
              ...
              {/* Hover Dark gradient list wrapper */}
              ...
              {/* Hover metadata labels sliding up */}
        ...
        {/* Dynamic Zoom Overlay Lightbox (Elite detailing) */}
        <AnimatePresence>
          {selectedPhoto && (
            <div 
            ...
            >
              ...
              >
                ...
                <div className="md:w-2/5 p-6 md:p-8 flex flex-col justify-between relative bg-slate-950">
                  ...
                  {/* Institution signature indicators */}
